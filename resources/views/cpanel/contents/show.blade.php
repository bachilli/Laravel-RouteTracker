        ...
        <table class="table table-bordered">
            ...
            @forelse ($contents as $content)
                <tr>
                    ...
                    <td class="w-75">{{ $content->name }}</td>
                    <td class="w-15 align-center">
                        <a class="btn btn-secondary" href="{{ action('CPanel\ContentController@show', $content->id) }}" data-toggle="tooltip" title="{{ trans('general.show') }}"><i class="fa fa-folder-open"></i></a>
                        <a class="btn btn-primary" href="{{ action('CPanel\ContentController@edit', $content->id) }}" data-toggle="tooltip" title="{{ trans('general.edit') }}"><i class="fa fa-pencil-square"></i></a>
